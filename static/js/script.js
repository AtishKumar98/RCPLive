...
for (let i = 0; i < incrementBtn.length; i++) {
  ...
  incrementBtn[i].addEventListener('click', function () {
    ...
    function toggleHide()
    {
        ...
        let para = document.getElementById('payment-form'); 
...
const d = document.querySelector('.method');
const r = document.querySelector('.rem');
const p = document.querySelector('.method2');
...
p.addEventListener('click',()=>{
  paypal.classList.add('fill');

});
// buttons.forEach(button => {
//   button.addEventListener('click',function(){
//     buttons.forEach(btn => btn.classList.remove('fill'));
